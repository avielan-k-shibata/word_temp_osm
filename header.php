...
ga('create', 'UA-6358653-1','auto',{'allowLinker':true});
...
<div id="headermenu" class="pc">
	<ul>
		<li><h1 class="logo"><a href="/"><img src="/company/wp-content/themes/gk-portfolio/img/top/logo.png" alt="OSMOSIS loaf" /></a></h1></li>
		<li class="search2018">
...
<div id="contents_base">
    ...
    <a class="logout rank_$MEMBER_STAGE_ORDER_NO$" href="/fs/osmosis/Logout.html">ログアウト</a>
			...
			<li class="pcw25"><p>10,000円以上お買い上げで送料無料</p></li>
		</ul>
	</div>
